      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        <AnimatedSection animation="scale-in">
          <div className="inline-flex items-center gap-2 rounded-full border border-secondary/20 bg-secondary/5 px-4 py-1.5 mb-6">
            <span className="text-xs font-semibold uppercase tracking-widest text-secondary">Colaboración</span>
          </div>
          ...
          <p className="mb-10 text-lg text-muted max-w-2xl mx-auto">
            Estamos abiertos a colaboraciones académicas, proyectos de investigación conjuntos y servicios tecnológicos para la industria.
          </p>
